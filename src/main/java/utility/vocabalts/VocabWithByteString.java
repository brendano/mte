...
import static utility.vocabalts.VocabWithByteString.encodeUTF8;
...
== ByteString, HashMap ==
  ...
  ./java.sh utility.vocabalts.VocabWithByteString src/utility.vocabalts/featnames.txt  20.29s user 0.44s system 177% cpu 11.667 total
  init = 134217728(131072K) used = 397107888(387800K) committed = 541065216(528384K) max = 3817865216(3728384K)
  ./java.sh utility.vocabalts.VocabWithByteString src/utility.vocabalts/featnames.txt  20.59s user 0.41s system 179% cpu 11.709 total
  init = 134217728(131072K) used = 397157280(387848K) committed = 542113792(529408K) max = 3817865216(3728384K)
  ./java.sh utility.vocabalts.VocabWithByteString src/utility.vocabalts/featnames.txt  21.41s user 0.44s system 174% cpu 12.500 total
...
== ByteString, TObjectIntHashMap (Trove 3.0.3) ==
  ...
  ./java.sh utility.vocabalts.VocabWithByteString src/utility.vocabalts/featnames.txt  10.54s user 0.36s system 153% cpu 7.111 total
  init = 134217728(131072K) used = 265599992(259374K) committed = 470810624(459776K) max = 3817865216(3728384K)
  ./java.sh utility.vocabalts.VocabWithByteString src/utility.vocabalts/featnames.txt  9.48s user 0.35s system 155% cpu 6.308 total
  init = 134217728(131072K) used = 265645224(259419K) committed = 440926208(430592K) max = 3817865216(3728384K)
  ./java.sh utility.vocabalts.VocabWithByteString src/utility.vocabalts/featnames.txt  10.21s user 0.35s system 152% cpu 6.942 total
...
== ByteString, Object2IntOpenHashMap (fastutil 6.4.6) ==
  ...
  ./java.sh utility.vocabalts.VocabWithByteString src/utility.vocabalts/featnames.txt  10.15s user 0.41s system 149% cpu 7.061 total
  init = 134217728(131072K) used = 288304744(281547K) committed = 488112128(476672K) max = 3817865216(3728384K)
  ./java.sh utility.vocabalts.VocabWithByteString src/utility.vocabalts/featnames.txt  9.82s user 0.40s system 149% cpu 6.828 total
  init = 134217728(131072K) used = 288011832(281261K) committed = 479723520(468480K) max = 3817865216(3728384K)
  ./java.sh utility.vocabalts.VocabWithByteString src/utility.vocabalts/featnames.txt  9.88s user 0.36s system 149% cpu 6.843 total
