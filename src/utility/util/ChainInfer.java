 ...
 *     Rscript sim_chains.r && ../java.sh utility.util.ChainInfer obsF transF
...
//				U.p("sol " + Arrays.toString(ys) + " weight " + weight);
	...
	/** testing: ensure this gives the correct number of outputs: ./java.sh utility.util.ChainInfer | wc -l */
...
//	public static void main(String[] args) { testExhaustiveCalls(); }
	 ...
	 * 
~/myutil/chains % Rscript sim_chains.r && ../java.sh utility.util.ChainInfer obsF transF
EXHAUS	[0, 1, 1, 1, 0]
VITERBI	[0, 1, 1, 1, 0]
	 */
