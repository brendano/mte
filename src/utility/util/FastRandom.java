...
//    	java.utility.util.Random r = new java.utility.util.Random();
    	// Mallet "Randoms" uses java.utility.util.Random's RNG (it's a subclass), and has nextUniform()
//    	cc.mallet.utility.util.Randoms r = new cc.mallet.utility.util.Randoms();
