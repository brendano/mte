...
== Java String keys with HashMap ==
  ...
  ./java.sh utility.vocabalts.VocabWithString src/utility.vocabalts/featnames.txt  20.42s user 0.47s system 179% cpu 11.643 total
  init = 134217728(131072K) used = 501011664(489269K) committed = 612892672(598528K) max = 3817865216(3728384K)
  ./java.sh utility.vocabalts.VocabWithString src/utility.vocabalts/featnames.txt  23.45s user 0.49s system 180% cpu 13.259 total
  init = 134217728(131072K) used = 501040240(489297K) committed = 548929536(536064K) max = 3817865216(3728384K)
  ./java.sh utility.vocabalts.VocabWithString src/utility.vocabalts/featnames.txt  20.36s user 0.43s system 178% cpu 11.656 total
...
== Java String keys, TObjectIntHashMap, Trove 3.0.3 ==
  ...
  ./java.sh utility.vocabalts.VocabWithString src/utility.vocabalts/featnames.txt  10.55s user 0.38s system 165% cpu 6.610 total
  init = 134217728(131072K) used = 368895040(360249K) committed = 401080320(391680K) max = 3817865216(3728384K)
  ./java.sh utility.vocabalts.VocabWithString src/utility.vocabalts/featnames.txt  12.23s user 0.37s system 166% cpu 7.580 total
  init = 134217728(131072K) used = 369396088(360738K) committed = 463994880(453120K) max = 3817865216(3728384K)
  ./java.sh utility.vocabalts.VocabWithString src/utility.vocabalts/featnames.txt  10.78s user 0.38s system 163% cpu 6.832 total
...
== Java String keys, Object2IntOpenHashMap, fastutil 6.4.6 ==
  ...
  ./java.sh utility.vocabalts.VocabWithString src/utility.vocabalts/featnames.txt  9.97s user 0.36s system 161% cpu 6.400 total
  init = 134217728(131072K) used = 391759608(382577K) committed = 519045120(506880K) max = 3817865216(3728384K)
  ./java.sh utility.vocabalts.VocabWithString src/utility.vocabalts/featnames.txt  11.24s user 0.36s system 163% cpu 7.077 total
  init = 134217728(131072K) used = 391973248(382786K) committed = 505413632(493568K) max = 3817865216(3728384K)
  ./java.sh utility.vocabalts.VocabWithString src/utility.vocabalts/featnames.txt  10.67s user 0.36s system 163% cpu 6.756 total
